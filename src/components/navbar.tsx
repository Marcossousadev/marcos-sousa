...
export function Navbar() {
  return (
    <nav className="fixed top-6 w-[90%] h-16 px-6 flex items-center justify-between 
    bg-[#222222]/80 rounded-full backdrop-blur-md border-b border-white/10 text-foreground">
