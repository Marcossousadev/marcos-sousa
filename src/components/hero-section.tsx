...
export function HeroSection() {
    return (
        <div className="w-full lg:min-h-screen flex flex-col md:flex-row items-center md:justify-around gap-3 md:gap-0 text-foreground pt-28">
            <div className="inline-block p-[3px] md:hidden rounded-full bg-gradient-to-r from-pink-400 via-orange-300 to-purple-400">
                <Image src={MarcosDev}
                    alt="img_marcos"
            ...
            <div className="flex flex-col items-center md:items-start md:gap-2 md:ml-20">
                <h1
                    className="text-foreground font-bold text-center text-3xl md:text-4xl mx-10 md:mx-0 md:w-sm md:text-start lg:text-6xl lg:w-2xl">Eu sou programador e  crio soluções como <span className="bg-gradient-to-r from-orange-500 via-pink-400 to-purple-300 bg-clip-text text-transparent">freelancer!</span></h1>
                <p className="text-[#C5C5C5] text-base mt-2 text-center w-2xs mx-10 md:mx-0 md:text-start md:w-sm md:text-lg lg:text-2xl lg:w-2xl lg:mt-5">
                ...
                <div
                    className="hidden md:flex md:flex-row md:gap-2 md:mt-5">
            ...
            <div
                className="flex flex-row gap-2 mt-5 md:hidden">
                <LinkAction href="https://wa.me/558597961611?text=Oi%20tenho%20interesse%20no%20seu%20serviço" text="Fale comigo!" />
                <LinkAction href="/curriculo.pdf" text="Baixar Currículo" transparent download={true} />
            </div>
            <div className="hidden md:inline-block p-[3px] rounded-full bg-gradient-to-r from-pink-400 via-orange-300 to-purple-400 mr-20">
                <Image src={MarcosDev}
                    alt="img_marcos"
